vec3 getWaterColor(vec3 originalColor, float viewDistance) {
   ...
   // absorbtion: vec3(0.650, 0.0638, 0.0145); vec3(0.5722, 0.0588, 0.0114); vec3(0.601, 0.0558, 0.0226); //ocean water: vec3(0.6, 0.035, 0.003); //vec3(0.624, 0.0565, 0.00922); //plankton: vec3(0.003, 0.008, 0.0371)
   // scatter:    vec3(0.0007, 0.0019, 0.0045); vec3(0.0005, 0.0014, 0.0033); 0.004, 0.01, 0.024 (1/(wl^4)); 
   vec3 absorptionCoefficient = vec3(0.650, 0.0638, 0.0145);
